...
var exampleController = Controller{
	...
	DataTypes: []DataType{
		DataType{
			Name:   "dow",
			Family: DataTypeFamilyNone,
			Members: []Member{
				Member{
					Name:           "DayOW",
					DataType:       "INT",
					Radix:          RadixDecimal,
					ExternalAccess: ExternalAccessReadWrite,
				},
				Member{
					Name:           "Month",
					DataType:       "DINT",
	...
	Modules: []Module{
		Module{
			...
			Inhibited:       false,
			MajorFault:      true,
			EKey:            EKeyState_s{State: EKeyStateExactMatch},
			Ports: []Port{
				Port{
					Id:   1,
			...
			Communications: Communications{
				ConfigTag: ConfigTag{
					...
					Data: []Data{
						...
						Data{
							Format: DataFormatDecorated,
							L5K:    "\n\n",
							Structure: Structure{
								DataType: "AB:1769_IF4:C:0",
								DataValueMember: []DataValueMember{
									DataValueMember{Name: "RealTimeSample", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "TimestampEn", DataType: "BOOL", Value: "0"},
									DataValueMember{Name: "Ch00Filter", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									...
									DataValueMember{Name: "Ch00RangeType", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch00DataFormat", DataType: "SINT", Radix: RadixDecimal, Value: "1"},
									DataValueMember{Name: "Ch00HAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch00LAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch00AlarmDeadband", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch01Filter", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									...
									DataValueMember{Name: "Ch01RangeType", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch01DataFormat", DataType: "SINT", Radix: RadixDecimal, Value: "1"},
									DataValueMember{Name: "Ch01HAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch01LAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch01AlarmDeadband", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch02Filter", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									...
									DataValueMember{Name: "Ch02RangeType", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch02DataFormat", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch02HAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch02LAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "1"},
									DataValueMember{Name: "Ch02AlarmDeadband", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch03Filter", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									...
									DataValueMember{Name: "Ch03RangeType", DataType: "SINT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch03DataFormat", DataType: "SINT", Radix: RadixDecimal, Value: "4"},
									DataValueMember{Name: "Ch03HAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch03LAlarmLimit", DataType: "INT", Radix: RadixDecimal, Value: "0"},
									DataValueMember{Name: "Ch03AlarmDeadband", DataType: "INT", Radix: RadixDecimal, Value: "4"},
								},
							},
						},
					},
				...
				Connections: []Connection{Connection{
						...
						Data: []Data{Data{
							...
							Structure: Structure{
								...
								DataValueMember: []DataValueMember{
									...
									DataValueMember{Name: "Ch00Data", DataType: "INT", Radix: RadixDecimal, Value: "3457"},
									DataValueMember{Name: "Ch01Data", DataType: "INT", Radix: RadixDecimal, Value: "5234"},
									DataValueMember{Name: "Ch02Data", DataType: "INT", Radix: RadixDecimal, Value: "2722"},
									DataValueMember{Name: "Ch03Data", DataType: "INT", Radix: RadixDecimal, Value: "2622"},
									DataValueMember{Name: "Timestamp", DataType: "INT", Radix: RadixDecimal, Value: "4"},
					...
					OutputTag: IOTag{
						...
						Data: []Data{
							...
							Data{Format: DataFormatDecorated,
								L5K: "\n\n",
								Structure: Structure{
	...
	Tags: []Tag{
		Tag{
			...
			DataType:       "alarm_info",
			ExternalAccess: ExternalAccessReadWrite,
			Data: Data{Format: DataFormatDecorated,
				L5K: "\n\n",
				Structure: Structure{
					DataType: "alarm_info",
		...
		Tags: []Tag{Tag{
			...
			Data: Data{Format: DataFormatDecorated,
				...
				Structure: Structure{
					DataType: "dow",
					DataValueMember: []DataValueMember{
						DataValueMember{Name: "DayOW", DataType: "INT", Radix: RadixDecimal, Value: "3"},
						DataValueMember{Name: "Month", DataType: "DINT", Radix: RadixDecimal, Value: "12"},
